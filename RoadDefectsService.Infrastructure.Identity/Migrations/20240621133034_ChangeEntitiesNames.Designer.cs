...
namespace RoadDefectsService.Infrastructure.Identity.Migrations
{
    ...
    [Migration("20240621133034_ChangeEntitiesNames")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.AssignmentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.ContractorEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.DefectTypeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.FixationDefectEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.FixationWorkEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.OperatorEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.PhotoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.RoadInspectorEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.TaskFixationDefectEntity", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("TaskFixationDefectEntity");
                });

            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.TaskFixationWorkEntity", b =>
                {
                    b.HasBaseType("RoadDefectsService.Core.Domain.Models.TaskEntity");
                    ...
                    b.HasDiscriminator().HasValue("TaskFixationWorkEntity");
                });
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.AssignmentEntity", b =>
                {
                    b.HasOne("RoadDefectsService.Core.Domain.Models.ContractorEntity", "Contractor")
                        .WithMany()
                        .HasForeignKey("ContractorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoadDefectsService.Core.Domain.Models.FixationDefectEntity", "FixationDefect")
                        .WithOne()
                        .HasForeignKey("RoadDefectsService.Core.Domain.Models.AssignmentEntity", "FixationDefectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.FixationDefectEntity", b =>
                {
                    b.HasOne("RoadDefectsService.Core.Domain.Models.DefectTypeEntity", "DefectType")
                        .WithMany()
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.OperatorEntity", b =>
                {
                    b.HasOne("RoadDefectsService.Core.Domain.Models.CustomUser", "User")
                        .WithOne()
                        .HasForeignKey("RoadDefectsService.Core.Domain.Models.OperatorEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.PhotoEntity", b =>
                {
                    b.HasOne("RoadDefectsService.Core.Domain.Models.FixationDefectEntity", null)
                        .WithMany("Photos")
                        .HasForeignKey("FixationDefectId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RoadDefectsService.Core.Domain.Models.FixationWorkEntity", null)
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.RoadInspectorEntity", b =>
                {
                    b.HasOne("RoadDefectsService.Core.Domain.Models.CustomUser", "User")
                        .WithOne()
                        .HasForeignKey("RoadDefectsService.Core.Domain.Models.RoadInspectorEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.TaskEntity", b =>
                {
                    ...
                    b.HasOne("RoadDefectsService.Core.Domain.Models.RoadInspectorEntity", "RoadInspector")
            ...
            modelBuilder.Entity("RoadDefectsService.Core.Domain.Models.TaskFixationWorkEntity", b =>
                {
                    b.HasOne("RoadDefectsService.Core.Domain.Models.FixationWorkEntity", "FixationWork")
                        .WithOne("TaskFixationWork")
                        .HasForeignKey("RoadDefectsService.Core.Domain.Models.TaskFixationWorkEntity", "FixationWorkId");

                    b.HasOne("RoadDefectsService.Core.Domain.Models.TaskEntity", "PrevTask")
                        .WithOne("NextTask")
                        .HasForeignKey("RoadDefectsService.Core.Domain.Models.TaskFixationWorkEntity", "PrevTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
